...
public class CreateOrderResponse {
    ...
    public CreateOrderResponse(Long id, String orderNumber, String customerName, String productName, int quantity, LocalDate orderDate, OrderStatus status, long totalPrice, String customerEmail, Long createdByAdminId, String createdByAdminName, String createdByAdminEmail, Role createdByAdminRole) {
        this.id = id;
