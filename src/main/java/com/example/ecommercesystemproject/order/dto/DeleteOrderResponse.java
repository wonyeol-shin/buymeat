...
public class DeleteOrderResponse {
    ...
    public DeleteOrderResponse(Long id, String orderNumber, String customerName, String productName, int quantity, LocalDate orderDate, OrderStatus status, long totalPrice, String customerEmail, Long createdByAdminId, String createdByAdminName, String createdByAdminEmail, Role createdByAdminRole, String cancellationReason) {
        this.id = id;
